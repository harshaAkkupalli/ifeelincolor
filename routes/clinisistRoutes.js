...
router
  .route("/update-dp/:id")
  .put(clincistProtect, upload.single("image"), updateDoctorImage);
router.put("/update-doctor", clincistProtect, updateDoctor);
router
  .route("/subscribed-patients")
  .get(clincistProtect, getSubscribedPatients);
router
  .route("/subscribed-patients-assessments")
  .get(clincistProtect, getSubscribedPatientsAssessments);
router
  .route("/subscribed-patient-assessment-infos/:patientId")
  .get(clincistProtect, getAssessmentInfoByPatientId);
router
  .route("/subscription-stats")
  .get(clincistProtect, getClinicistSubscriptionStats);
router.route("/sales-stats").get(clincistProtect, getClinicistSalesStats);
router
  .route("/recommendation-stats")
  .get(clincistProtect, getClinicistRecommendationStats);
router
  .route("/nearby-subscribed-patients-assessments")
  .post(clincistProtect, getNearbySubscribedPatientsAssessments);
router
  .route("/recommended-patients")
  .get(clincistProtect, getClinicistRecommendationsAndPatients);
router
  .route("/check-active-subscription")
  .get(clincistProtect, checkClinicistActiveSubscription);
router.put(
