...
const subColor = require('./routes/subColorRoutes');
const subSubColor = require('./routes/subSubColorRoutes');
const body = require('./routes/bodyRoutes');
const bodyassessments = require('./routes/bodyAssessmentRoutes');
const bodyAssignmentRoutes = require('./routes/bodyAssignmentRoutes');
const emotionCardRoutes = require('./routes/emotionCardRoutes');
...
app.use('/api/admin', subColor);
app.use('/api/admin', subSubColor);
app.use('/api/admin/', body);
app.use('/api',bodyassessments);
app.use('/api', emotionCardRoutes);
...
app.use('/api/body-assignments', bodyAssignmentRoutes);
